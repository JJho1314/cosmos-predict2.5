...
#SBATCH --output=/data/user/jhe724/workspace/cosmos-predict2.5/slurm-tavid-orange-%j.out
#SBATCH --error=/data/user/jhe724/workspace/cosmos-predict2.5/slurm-tavid-orange-%j.err
...
export DROID_SUCCESS_V21_TAVID_DIR=${DROID_SUCCESS_V21_TAVID_DIR:-/data/user/jhe724/workspace/cosmos-predict2.5/outputs/tavid_generation_runs/orange_cup_custom_dataset}
...
CKPT=${CKPT:-/data/user/jhe724/workspace/cosmos-predict2.5/outputs/droid_success_v21_tavid_mask_left_right_split/cosmos_predict_v2p5/video2world/2b_droid_success_v21_tavid_mask_480_lr_split_val1k_49f_s234_actionstart_bs4accum2_14k_val1000/checkpoints/iter_000014000}
OUT=${OUT:-/data/user/jhe724/workspace/cosmos-predict2.5/outputs/tavid_generation_runs/orange_cup_custom_tgt_49f_35step}
...
cat "$DROID_SUCCESS_V21_TAVID_DIR/metas/orange_cup_dishwasher.txt"
